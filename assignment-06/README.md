There are only one <head> and one <body> element on the page. Head is information for the browser to read and body is where all of the "guts" of the code live and what is displayed. 
